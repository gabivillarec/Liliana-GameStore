    ...
    return(
        <nav id="navbar-example2" className={`navbar px-3 p-3 ${style.navbarE}`}>
            ...
            <div className="d-flex flex-wrap gap-2">
                ...
                <button className="btn btn-outline-info border-2 fs-5" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">User</button>
            </div>
            <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                <div className={`offcanvas-header ${style.perfilCanvaHeader}`}>
                    <h5 className="offcanvas-title text-info" id="offcanvasExampleLabel">Perfil name</h5>
